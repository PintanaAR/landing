...
const MODULES: ModuleCard[] = [
  {
    number: '01',
    label: 'Gestión + Analítica en vivo',
    title: 'Los números que importan, ahora.',
    body: 'Ventas, caja, compras y ARCA en el mismo flujo. Tus KPIs se actualizan al instante — no a fin de mes, no cuando llamás al contador.',
    paint: 'var(--navy)',
    tags: ['KPIs en vivo', 'Multi-sucursal', 'Caja y banco', 'Reportes al contador', 'ARCA integrado'],
    wide: true,
  },
  {
    number: '02',
  ...
  },
  {
    ...
    body: 'Alertas automáticas por mínimo. Reposición sugerida con IA en base a tu histórico real. Y un aviso por WhatsApp antes de que se te acabe el balde top.',
    paint: 'var(--sage)',
  },
  {
    number: '04',
    label: 'Tu equipo + RRHH',
    title: 'Cada peso, con responsable.',
    body: 'Permisos por rol, horarios y comisiones desde el mismo sistema. Sin planillas paralelas, sin discusiones a fin de mes.',
    paint: 'var(--purple)',
    bullets: [
      'Permisos por rol — cada quien ve sólo lo suyo',
      'Horarios y asistencia de empleados (RRHH)',
      'Comisiones por vendedor, calculadas solas',
      'La caja siempre cierra con un responsable firmado',
    ],
    wide: true,
  },
]
